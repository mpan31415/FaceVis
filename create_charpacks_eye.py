...
def update_json(jsonfile, new_json_filename, eye_index):
    # Read the JSON file
    ...
    texture_sets_dict['eyes'] = "eye"+str(eye_index)
...
# counter = 1
# files_in_directory = list_files_in_directory("./models_src/adult/textures/eye")
...
for ei in range(1, 24):
    update_json(JSON_SRC+'/'+BASE_CHAR_NAME+'.json', 'models/adult/profiles/characters/'+NEW_CHAR_NAME+str(ei)+".json", ei)
